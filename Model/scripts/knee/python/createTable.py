...
SQL="select * \
	from KNEE_AGGREGATE_CONTENTION \
...
class AggregateDecision:
	def __init__(self,VET_ID, PROFILE_DATE,PROMULGATION_DATE,RECENT_KNEE_DATE,CDD,KNEE_CDD,A5164,A5165,A5163,A5162,A5161,A5256,A5258,A5257,A5313,A5314,A5315,A5055,A5261,A5260,A5259,TXT_BILATERAL,TXT_LEFT,TXT_RIGHT,TXT_KNEE,TXT_IMPAIRMENT,TXT_LIMITATION,TXT_AMPUTATION,TXT_ANKYLOSES):
		self.VET_ID = VET_ID
...
for row in cursor:
	...
	for decisionRow in priorDecisionCursor:
		aggregateDecision = AggregateDecision(decisionRow[0],decisionRow[1],decisionRow[2],decisionRow[3],decisionRow[4],decisionRow[5],decisionRow[6],decisionRow[7],decisionRow[8],decisionRow[9],decisionRow[10],decisionRow[11],decisionRow[12],decisionRow[13],decisionRow[14],decisionRow[15],decisionRow[16],decisionRow[17],decisionRow[18],decisionRow[19],decisionRow[20],decisionRow[21],decisionRow[22],decisionRow[23],decisionRow[24],decisionRow[25],decisionRow[26],decisionRow[27],decisionRow[28])
	...
	if aggregateDecision is None:
		aggregateDecision = AggregateDecision(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)	
	...
	if not currDecisionRow is None:
		currAggregateDecision = AggregateDecision(currDecisionRow[0],currDecisionRow[1],currDecisionRow[2],currDecisionRow[3],currDecisionRow[4],currDecisionRow[5],currDecisionRow[6],currDecisionRow[7],currDecisionRow[8],currDecisionRow[9],currDecisionRow[10],currDecisionRow[11],currDecisionRow[12],currDecisionRow[13],currDecisionRow[14],currDecisionRow[15],currDecisionRow[16],currDecisionRow[17],currDecisionRow[18],currDecisionRow[19],currDecisionRow[20],currDecisionRow[21],currDecisionRow[22],currDecisionRow[23],currDecisionRow[24],currDecisionRow[25],currDecisionRow[26],currDecisionRow[27],currDecisionRow[28])
	else :
		currAggregateDecision = AggregateDecision(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
