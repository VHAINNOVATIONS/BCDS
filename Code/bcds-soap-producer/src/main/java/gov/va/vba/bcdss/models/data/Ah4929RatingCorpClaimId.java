 ...
 */
public class Ah4929RatingCorpClaimId implements java.io.Serializable {
	...
	private BigDecimal claimRoNumber;
	...
	public Ah4929RatingCorpClaimId() {
	}

	public Ah4929RatingCorpClaimId(long ptcpntVetId, Date prfilDt, long bnftClaimId, Date dateOfClaim,
			String bnftClaimTypeCd, String claimLabel, String statusTypeCd, BigDecimal claimRoNumber,
			String claimRoName) {
	...
	public Ah4929RatingCorpClaimId(long ptcpntVetId, Date prfilDt, long bnftClaimId, String endPrdctTypeCd,
			Date dateOfClaim, String payeeTypeCd, String bnftClaimTypeCd, String claimLabel, String statusTypeCd,
			BigDecimal claimRoNumber, String claimRoName, String cntntnId, Long cntntnClsfcnId, String cntntnTypeCd,
	...
	public BigDecimal getClaimRoNumber() {
		return this.claimRoNumber;
	}

	public void setClaimRoNumber(BigDecimal claimRoNumber) {
		this.claimRoNumber = claimRoNumber;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof Ah4929RatingCorpClaimId))
			return false;
		Ah4929RatingCorpClaimId castOther = (Ah4929RatingCorpClaimId) other;
		...
		return (this.getPtcpntVetId() == castOther.getPtcpntVetId())
				...
				&& ((this.getClaimRoNumber() == castOther.getClaimRoNumber())
						|| (this.getClaimRoNumber() != null && castOther.getClaimRoNumber() != null
								&& this.getClaimRoNumber().equals(castOther.getClaimRoNumber())))
	...
	public int hashCode() {
		...
		result = 37 * result + (getClaimRoNumber() == null ? 0 : this.getClaimRoNumber().hashCode());
		...
		result = 37 * result
				+ (getCntntnWellGrndedAplcblInd() == null ? 0 : this.getCntntnWellGrndedAplcblInd().hashCode());
