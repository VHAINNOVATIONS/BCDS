...
public interface ClaimRepository extends JpaRepository<Claim, Long> {
	...
	@Query(value = "SELECT Distinct C.PTCPNT_VET_ID, BNFT_CLAIM_ID, END_PRDCT_TYPE_CD, DATE_OF_CLAIM, PAYEE_TYPE_CD, BNFT_CLAIM_TYPE_CD, "
			...
			+ "CNTNTN_MED_IND, CNTNTN_WELL_GRNDED_APLCBL_IND, CNTNTN_BEGIN_DT, CNTNTN_SPECL_ISSUE_ID, CNTNTN_SPECL_ISSUE_TYPE_CD FROM BCDSS.AH4929_RATING_CORP_CLAIM C , "
			+ "BCDSS.AH4929_PERSON P WHERE C.PTCPNT_VET_ID = P.PTCPNT_VET_ID and CNTNTN_CLSFCN_ID in ('230','270','2200','2210','3140','3150','3690','3700','3710','3720',"
			+ "'3730','3780','3790','3800','4130','4210','4700','4920','5000','5010','5710','6850','8919') AND ROWNUM <= 150  AND ( (?1 is null or ?1='' or c.CNTNTN_CLMANT_TXT LIKE (?1) ) ) ORDER BY C.PTCPNT_VET_ID, DATE_OF_CLAIM", nativeQuery = true)
	List<Claim> findClaimsByContention(String contentionType);
	
	@Query(value = "SELECT Distinct C.PTCPNT_VET_ID, BNFT_CLAIM_ID, END_PRDCT_TYPE_CD, DATE_OF_CLAIM, PAYEE_TYPE_CD, BNFT_CLAIM_TYPE_CD, "
			+ "CLAIM_LABEL, STATUS_TYPE_CD, CLAIM_RO_NAME,CNTNTN_ID, CNTNTN_CLSFCN_ID, CNTNTN_CLMANT_TXT, CLAIM_RO_NUMBER, CNTNTN_TYPE_CD, "
			+ "CNTNTN_MED_IND, CNTNTN_WELL_GRNDED_APLCBL_IND, CNTNTN_BEGIN_DT FROM BCDSS.AH4929_RATING_CORP_CLAIM C , "
			+ "BCDSS.AH4929_PERSON P WHERE C.PTCPNT_VET_ID = P.PTCPNT_VET_ID and CNTNTN_CLSFCN_ID in ('230','270','2200','2210','3140','3150','3690','3700','3710','3720',"
			+ "'3730','3780','3790','3800','4130','4210','4700','4920','5000','5010','5710','6850','8919') AND ROWNUM <= 150  AND ( (?1 is null or ?1='' or c.CNTNTN_CLMANT_TXT LIKE (?1) ) "
			+ "AND (c.CLAIM_RO_NUMBER = ?2) ) ORDER BY C.PTCPNT_VET_ID, DATE_OF_CLAIM", nativeQuery = true)
	List<Claim> findClaimsByRegionalOffice(String contentionType, Long regionalOfficeNumber);
	
	@Query(value = "SELECT Distinct C.PTCPNT_VET_ID, BNFT_CLAIM_ID, END_PRDCT_TYPE_CD, DATE_OF_CLAIM, PAYEE_TYPE_CD, BNFT_CLAIM_TYPE_CD, "
			+ "CLAIM_LABEL, STATUS_TYPE_CD, CLAIM_RO_NAME,CNTNTN_ID, CNTNTN_CLSFCN_ID, CNTNTN_CLMANT_TXT, CLAIM_RO_NUMBER, CNTNTN_TYPE_CD, "
			+ "CNTNTN_MED_IND, CNTNTN_WELL_GRNDED_APLCBL_IND, CNTNTN_BEGIN_DT FROM BCDSS.AH4929_RATING_CORP_CLAIM C , "
			+ "BCDSS.AH4929_PERSON P WHERE C.PTCPNT_VET_ID = P.PTCPNT_VET_ID and CNTNTN_CLSFCN_ID in ('230','270','2200','2210','3140','3150','3690','3700','3710','3720',"
			+ "'3730','3780','3790','3800','4130','4210','4700','4920','5000','5010','5710','6850','8919') AND ROWNUM <= 150  AND ( (?1 is null or ?1='' or c.CNTNTN_CLMANT_TXT LIKE (?1) ) AND (c.DATE_OF_CLAIM >= ?2 AND c.DATE_OF_CLAIM <= ?3) ) ORDER BY C.PTCPNT_VET_ID, DATE_OF_CLAIM", nativeQuery = true)
	List<Claim> findClaimsByDates(String contentionType, Date fromDate, Date toDate);
	...
	@Query(value = "SELECT Distinct C.PTCPNT_VET_ID, BNFT_CLAIM_ID, END_PRDCT_TYPE_CD, DATE_OF_CLAIM, PAYEE_TYPE_CD, BNFT_CLAIM_TYPE_CD, "
			...
			+ "BCDSS.AH4929_PERSON P WHERE C.PTCPNT_VET_ID = P.PTCPNT_VET_ID and CNTNTN_CLSFCN_ID in ('230','270','2200','2210','3140','3150','3690','3700','3710','3720',"
			+ "'3730','3780','3790','3800','4130','4210','4700','4920','5000','5010','5710','6850','8919') AND ROWNUM <= 150  AND ( (?1 is null or ?1='' or c.CNTNTN_CLMANT_TXT LIKE (?1) ) "
			+ "AND (c.CLAIM_RO_NUMBER = ?2) AND (c.DATE_OF_CLAIM >= ?3 AND c.DATE_OF_CLAIM <= ?4) ) ORDER BY C.PTCPNT_VET_ID, DATE_OF_CLAIM", nativeQuery = true)
	List<Claim> findClaimsByAllFilters(String contentionType, Long regionalOfficeNumber, Date fromDate, Date toDate);
}