...
public interface ClaimRepository extends JpaRepository<Claim, Long> {
	...
	@Query(value= "SELECT distinct C.PTCPNT_VET_ID,  BNFT_CLAIM_ID, CNTNTN_CLSFCN_ID, DATE_OF_CLAIM, CLAIM_RO_NAME, CNTNTN_CLMANT_TXT FROM BCDSS.AH4929_RATING_CORP_CLAIM C , BCDSS.AH4929_PERSON P WHERE C.PTCPNT_VET_ID = P.PTCPNT_VET_ID and CNTNTN_CLSFCN_ID in ('230','270','2200','2210','3140','3150','3690','3700','3710','3720','3730','3780','3790','3800','4130','4210','4700','4920','5000','5010','5710','6850','8919') AND ROWNUM <= 150 ORDER BY C.PTCPNT_VET_ID, DATE_OF_CLAIM", nativeQuery = true)
