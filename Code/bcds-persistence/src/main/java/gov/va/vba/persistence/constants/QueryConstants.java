...
public class QueryConstants {
    ...
    public static final String KNEE_PRIOR_CDD_BEGIN_DATE = "SELECT BEGIN_DATE FROM BCDSS.AH4929_RATING_DECISION WHERE PRFIL_DT = (SELECT MIN(PRFIL_DT) FROM BCDSS.AH4929_RATING_DECISION WHERE  PRFIL_DT >= ? AND PTCPNT_VET_ID = ? " +
            "AND DIAGNOSIS_CODE IN  ('5055','5161','5162','5163','5164','5165','5256','5257','5258','5259','5260','5261','5262','5263','5264','5313','5314','5315') AND DSBLTY_DECN_TYPE_CD IN ('SVCCONNCTED','1151GRANTED'))";
    ...
    public static final String CLAIMS_QUERY = "SELECT DISTINCT C.PTCPNT_VET_ID AS veteranId, BNFT_CLAIM_ID AS claimId, " +
            ...
            " AND D.MODEL_TYPE in (select D.MODEL_TYPE from BCDSS.DDM_CNTNT  where D.CNTNT_CD = C.CNTNTN_CLSFCN_ID) AND ROWNUM <= 150 ORDER BY C.PTCPNT_VET_ID, DATE_OF_CLAIM";
    ...
    public static  final String EAR_PRIOR_CDD_BEGIN_DATE = "SELECT BEGIN_DATE FROM AH4929_RATING_DECISION WHERE PRFIL_DT = (SELECT MIN(PRFIL_DT) " +
            "FROM BCDSS.AH4929_RATING_DECISION " +
            "WHERE PTCPNT_VET_ID = ?" +
