...
public class QueryConstants {
    ...
    public static final String CLAIMANT_AGE_QUERY = "SELECT  DISTINCT ROUND(EXTRACT(YEAR FROM C.DATE_OF_CLAIM) - P.DOB) AGE FROM BCDSS.AH4929_RATING_CORP_CLAIM  C, AH4929_PERSON P "+
            "WHERE C.PTCPNT_VET_ID = P.PTCPNT_VET_ID AND C.PTCPNT_VET_ID = ? AND BNFT_CLAIM_ID = ?";
}
