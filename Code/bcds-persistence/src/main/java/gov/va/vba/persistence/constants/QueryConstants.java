...
public class QueryConstants {
    ...
    public static final String KNEE_PRIOR_CDD_BEGIN_DATE = "SELECT BEGIN_DT FROM BCDSS.AH4929_RATING_DECISION WHERE PRFIL_DT = (SELECT MIN(PRFIL_DT) FROM BCDSS.AH4929_RATING_DECISION WHERE  PRFIL_DT >= ? AND PTCPNT_VET_ID = ? " +
            "AND DIAGNOSIS_CODE IN  ('5055','5161','5162','5163','5164','5165','5256','5257','5258','5259','5260','5261','5262','5263','5264','5313','5314','5315') AND DSBLTY_DECN_TYPE_CD IN ('SVCCONNCTED','1151GRANTED'))";
    ...
    public static  final String EAR_PRIOR_CDD_BEGIN_DATE = "SELECT BEGIN_DT FROM AH4929_RATING_DECISION WHERE PRFIL_DT = (SELECT MIN(PRFIL_DT) " +
            "FROM BCDSS.AH4929_RATING_DECISION " +
            "WHERE PTCPNT_VET_ID = ?" +
