...
public interface RatingDecisionRepository extends CrudRepository<RatingDecision, BigDecimal>{
    ...
    List<RatingDecision> findByVeteranVeteranIdAndPercentNumberNotNullAndDiagnosisCodeInAndDsbltyDecnTypeCdIn(Long veteranId, List<String> kneeDiagnosisCodes, List<String> decisionCodes);
