    ...
    var methods = {
        ...
        init: function(options) {
            ...
            if (!form.data('jqv') || form.data('jqv') == null ) {
                ...
                // Remove formError upon navigating to different tab
                $("#center-content").ready(function() {
        ...
        hide: function() {
            ...
            /** This is a total hack to fix error messages being thrown when an input value contains
             *  either ( or ) characters
             *  Added by JPalmer on 02/10/2016 for New DDI Refactor purposes **/
        ...
        _buildPrompt: function(field, promptText, type, ajaxed, options) {
            ...
            // create the prompt
            var prompt = $('<div aria-live="polite">');
